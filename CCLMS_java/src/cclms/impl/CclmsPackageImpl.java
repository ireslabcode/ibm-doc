...
public class CclmsPackageImpl extends EPackageImpl implements CclmsPackage {
	...
	public EReference getTrainMst_RefLinkDetailTrainId() {
		return (EReference) trainMstEClass.getEStructuralFeatures().get(3);
	}
	...
	public EReference getTrainMst_RefTrainSegmentMstTrainId() {
		return (EReference) trainMstEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKpiValue_CreatedBy() {
		return (EAttribute) kpiValueEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTrainSegmentMst_CreatedBy() {
		return (EAttribute) trainSegmentMstEClass.getEStructuralFeatures().get(
				12);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLinkMst_CreatedBy() {
	 ...
	 * @generated
	 */
	public EAttribute getLinkMst_LastModifiedBy() {
		return (EAttribute) linkMstEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getLinkMst_LinkStatus() {
		return (EAttribute) linkMstEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getTrainSegmentEngine_Trainid() {
		return (EAttribute) trainSegmentEngineEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getSegmentMstEngine_Fromstation() {
		return (EAttribute) segmentMstEngineEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getTimeToMinEngine_Trainid() {
		return (EAttribute) timeToMinEngineEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getDayMstEngine_DayId() {
		return (EAttribute) dayMstEngineEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getDayMstEngine_DayDesc() {
		return (EAttribute) dayMstEngineEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getKpiLinkEngine_KpiId() {
		return (EAttribute) kpiLinkEngineEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getKpiLinkEngine_KpiDesc() {
		return (EAttribute) kpiLinkEngineEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getKpiLinkEngine_KpiValue() {
		return (EAttribute) kpiLinkEngineEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getKpiLinkEngine_Uom() {
		return (EAttribute) kpiLinkEngineEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getLinkDetailEngine_Dayname() {
		return (EAttribute) linkDetailEngineEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getOutlinkEngine_Dayid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getOutlinkEngine_Seqid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getOutlinkEngine_Pairingid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getOutlinkEngine_Dutyid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getOutlinkEngine_Trainid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(4);
	}
	...
	public EAttribute getOutlinkEngine_Legid() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getOutlinkEngine_Startloc() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(6);
	}
	...
	public EAttribute getOutlinkEngine_Endloc() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getOutlinkEngine_Dutysignon() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(8);
	}
	...
	public EAttribute getOutlinkEngine_Starttime() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getOutlinkEngine_Endtime() {
		return (EAttribute) outlinkEngineEClass.getEStructuralFeatures()
				.get(10);
	}
	...
	public EAttribute getLobbyMstEngine_LobbyCode() {
		return (EAttribute) lobbyMstEngineEClass.getEStructuralFeatures()
				.get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUserMst_DivisionId() {
	...
	public void createPackageContents() {
		...
		createEAttribute(kpiValueEClass, KPI_VALUE__CREATED_BY);
		...
		createEAttribute(trainSegmentMstEClass, TRAIN_SEGMENT_MST__CREATED_BY);
		...
		createEAttribute(linkMstEClass, LINK_MST__CREATED_BY);
		createEAttribute(linkMstEClass, LINK_MST__LAST_MODIFIED_BY);
		...
		trainSegmentEngineEClass = createEClass(TRAIN_SEGMENT_ENGINE);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__TRAINID);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__LEGID);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__STARTLOC);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__ENDLOC);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__SIGNON);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__START);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__END);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__SIGNOFF);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__DURATION);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__DISTANCE);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__NIGHTFLAG);
		createEAttribute(trainSegmentEngineEClass, TRAIN_SEGMENT_ENGINE__DAYID);
		createEAttribute(trainSegmentEngineEClass,
				TRAIN_SEGMENT_ENGINE__SPAREFLAG);

		segmentMstEngineEClass = createEClass(SEGMENT_MST_ENGINE);
		createEAttribute(segmentMstEngineEClass,
				SEGMENT_MST_ENGINE__FROMSTATION);
		createEAttribute(segmentMstEngineEClass, SEGMENT_MST_ENGINE__TOSTATION);
		createEAttribute(segmentMstEngineEClass, SEGMENT_MST_ENGINE__SEGMENTID);

		timeToMinEngineEClass = createEClass(TIME_TO_MIN_ENGINE);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__TRAINID);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__SEGMENTID);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__SIGNONTIME);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__SIGNOMINUTE);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__STARTTIME);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__STARTMINUTE);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__ENDTIME);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__ENDMINUTE);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__SIGNOFFTIME);
		createEAttribute(timeToMinEngineEClass,
				TIME_TO_MIN_ENGINE__SIGNOFFMINUTE);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__DAYID);
		createEAttribute(timeToMinEngineEClass, TIME_TO_MIN_ENGINE__SPAREFLAG);

		kpiLinkEngineEClass = createEClass(KPI_LINK_ENGINE);
		createEAttribute(kpiLinkEngineEClass, KPI_LINK_ENGINE__KPI_ID);
		createEAttribute(kpiLinkEngineEClass, KPI_LINK_ENGINE__KPI_DESC);
		createEAttribute(kpiLinkEngineEClass, KPI_LINK_ENGINE__KPI_VALUE);
		createEAttribute(kpiLinkEngineEClass, KPI_LINK_ENGINE__UOM);

		linkDetailEngineEClass = createEClass(LINK_DETAIL_ENGINE);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__DAYNAME);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__SEQID);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__TRAINNO);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__FROMSTATION);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__TOSTATION);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__SIGNONTIME);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__DEPARTURETIME);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__ARRIVALTIME);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__SIGNOFFTIME);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__DUTYDURTION);
		createEAttribute(linkDetailEngineEClass,
				LINK_DETAIL_ENGINE__DUTYMINUTES);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__DISTANCE);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__NIB);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__SORTORDER);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__DAYID);
		createEAttribute(linkDetailEngineEClass, LINK_DETAIL_ENGINE__SPAREFLAG);

		outlinkEngineEClass = createEClass(OUTLINK_ENGINE);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__DAYID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__SEQID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__PAIRINGID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__DUTYID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__TRAINID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__LEGID);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__STARTLOC);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__ENDLOC);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__DUTYSIGNON);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__STARTTIME);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__ENDTIME);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__DUTYSIGNOFF);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__DURATION);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__NIB);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__SPAREFLAG);
		createEAttribute(outlinkEngineEClass, OUTLINK_ENGINE__SORTORDER);

		lobbyMstEngineEClass = createEClass(LOBBY_MST_ENGINE);
		createEAttribute(lobbyMstEngineEClass, LOBBY_MST_ENGINE__LOBBY_CODE);
		createEAttribute(lobbyMstEngineEClass, LOBBY_MST_ENGINE__LOBBY_NAME);
		createEAttribute(lobbyMstEngineEClass, LOBBY_MST_ENGINE__LOBBY_ID);
		...
		createEAttribute(userMstEClass, USER_MST__DIVISION_ID);

		dayMstEngineEClass = createEClass(DAY_MST_ENGINE);
		createEAttribute(dayMstEngineEClass, DAY_MST_ENGINE__DAY_ID);
		createEAttribute(dayMstEngineEClass, DAY_MST_ENGINE__DAY_DESC);
		...
		createEReference(cclmsCollectorEClass,
				CCLMS_COLLECTOR__TRAIN_SEGMENT_ENGINE);
		createEReference(cclmsCollectorEClass,
				CCLMS_COLLECTOR__SEGMENT_MST_ENGINE);
		createEReference(cclmsCollectorEClass,
				CCLMS_COLLECTOR__TIME_TO_MIN_ENGINE);
		createEReference(cclmsCollectorEClass, CCLMS_COLLECTOR__KPI_LINK_ENGINE);
		createEReference(cclmsCollectorEClass,
				CCLMS_COLLECTOR__LINK_DETAIL_ENGINE);
		createEReference(cclmsCollectorEClass, CCLMS_COLLECTOR__OUTLINK_ENGINE);
		createEReference(cclmsCollectorEClass,
				CCLMS_COLLECTOR__LOBBY_MST_ENGINE);
		createEReference(cclmsCollectorEClass, CCLMS_COLLECTOR__USER_MST);
		createEReference(cclmsCollectorEClass, CCLMS_COLLECTOR__DAY_MST_ENGINE);
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(stationMstEClass, null,
				"getLinkDetailFromStn", 0, 1, IS_UNIQUE, IS_ORDERED);
		EGenericType g1 = createEGenericType(this.getList());
		EGenericType g2 = createEGenericType(this.getLinkDetail());
		...
		initEAttribute(getKpiValue_Value(), ecorePackage.getEDouble(), "value",
				...
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getKpiValue_CreatedBy(), ecorePackage.getEInt(),
				"createdBy", null, 1, 1, KpiValue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTrainSegmentMst_ActualKm(),
				...
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTrainSegmentMst_CreatedBy(), ecorePackage.getEInt(),
				"createdBy", null, 1, 1, TrainSegmentMst.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLinkMst_LobbyType(), ecorePackage.getEString(),
				...
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkMst_CreatedBy(), ecorePackage.getEInt(),
				"createdBy", null, 0, 1, LinkMst.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkMst_LastModifiedBy(), ecorePackage.getEInt(),
				"lastModifiedBy", null, 0, 1, LinkMst.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(trainSegmentEngineEClass, TrainSegmentEngine.class,
				"TrainSegmentEngine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTrainSegmentEngine_Trainid(), ecorePackage.getEInt(),
				"trainid", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Legid(), ecorePackage.getEInt(),
				"legid", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Startloc(),
				ecorePackage.getEInt(), "startloc", null, 1, 1,
				TrainSegmentEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Endloc(), ecorePackage.getEInt(),
				"endloc", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Signon(), ecorePackage.getEInt(),
				"signon", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Start(), ecorePackage.getEInt(),
				"start", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_End(), ecorePackage.getEInt(),
				"end", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Signoff(), ecorePackage.getEInt(),
				"signoff", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Duration(),
				ecorePackage.getEInt(), "duration", null, 1, 1,
				TrainSegmentEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Distance(),
				ecorePackage.getEInt(), "distance", null, 1, 1,
				TrainSegmentEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Nightflag(),
				ecorePackage.getEInt(), "nightflag", null, 1, 1,
				TrainSegmentEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Dayid(), ecorePackage.getEInt(),
				"dayid", null, 1, 1, TrainSegmentEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrainSegmentEngine_Spareflag(),
				ecorePackage.getEInt(), "spareflag", null, 1, 1,
				TrainSegmentEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		addEOperation(trainSegmentEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(segmentMstEngineEClass, SegmentMstEngine.class,
				"SegmentMstEngine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSegmentMstEngine_Fromstation(),
				ecorePackage.getEString(), "fromstation", null, 1, 1,
				SegmentMstEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSegmentMstEngine_Tostation(),
				ecorePackage.getEString(), "tostation", null, 1, 1,
				SegmentMstEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSegmentMstEngine_Segmentid(), ecorePackage.getEInt(),
				"segmentid", null, 1, 1, SegmentMstEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(segmentMstEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(timeToMinEngineEClass, TimeToMinEngine.class,
				"TimeToMinEngine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTimeToMinEngine_Trainid(), ecorePackage.getEInt(),
				"trainid", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Segmentid(), ecorePackage.getEInt(),
				"segmentid", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Signontime(),
				ecorePackage.getEString(), "signontime", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Signominute(),
				ecorePackage.getEInt(), "signominute", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Starttime(),
				ecorePackage.getEString(), "starttime", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Startminute(),
				ecorePackage.getEInt(), "startminute", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Endtime(), ecorePackage.getEString(),
				"endtime", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Endminute(), ecorePackage.getEInt(),
				"endminute", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Signofftime(),
				ecorePackage.getEString(), "signofftime", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Signoffminute(),
				ecorePackage.getEInt(), "signoffminute", null, 1, 1,
				TimeToMinEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Dayid(), ecorePackage.getEInt(),
				"dayid", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeToMinEngine_Spareflag(), ecorePackage.getEInt(),
				"spareflag", null, 1, 1, TimeToMinEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(timeToMinEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(kpiLinkEngineEClass, KpiLinkEngine.class, "KpiLinkEngine",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getKpiLinkEngine_KpiId(), ecorePackage.getEInt(),
				"kpiId", null, 1, 1, KpiLinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getKpiLinkEngine_KpiDesc(), ecorePackage.getEString(),
				"kpiDesc", null, 1, 1, KpiLinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getKpiLinkEngine_KpiValue(), ecorePackage.getEDouble(),
				"kpiValue", null, 1, 1, KpiLinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getKpiLinkEngine_Uom(), ecorePackage.getEString(),
				"uom", null, 0, 1, KpiLinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(kpiLinkEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(linkDetailEngineEClass, LinkDetailEngine.class,
				"LinkDetailEngine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLinkDetailEngine_Dayname(),
				ecorePackage.getEString(), "dayname", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Seqid(), ecorePackage.getEInt(),
				"seqid", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Trainno(),
				ecorePackage.getEString(), "trainno", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Fromstation(),
				ecorePackage.getEString(), "fromstation", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Tostation(),
				ecorePackage.getEString(), "tostation", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Signontime(),
				ecorePackage.getEString(), "signontime", null, 0, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Departuretime(),
				ecorePackage.getEString(), "departuretime", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Arrivaltime(),
				ecorePackage.getEString(), "arrivaltime", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Signofftime(),
				ecorePackage.getEString(), "signofftime", null, 0, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Dutydurtion(),
				ecorePackage.getEString(), "dutydurtion", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Dutyminutes(),
				ecorePackage.getEInt(), "dutyminutes", null, 1, 1,
				LinkDetailEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Distance(), ecorePackage.getEInt(),
				"distance", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Nib(), ecorePackage.getEInt(),
				"nib", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Sortorder(), ecorePackage.getEInt(),
				"sortorder", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Dayid(), ecorePackage.getEInt(),
				"dayid", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLinkDetailEngine_Spareflag(), ecorePackage.getEInt(),
				"spareflag", null, 1, 1, LinkDetailEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(linkDetailEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(outlinkEngineEClass, OutlinkEngine.class, "OutlinkEngine",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOutlinkEngine_Dayid(), ecorePackage.getEInt(),
				"dayid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Seqid(), ecorePackage.getEInt(),
				"seqid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Pairingid(), ecorePackage.getEInt(),
				"pairingid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Dutyid(), ecorePackage.getEInt(),
				"dutyid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Trainid(), ecorePackage.getEInt(),
				"trainid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Legid(), ecorePackage.getEInt(),
				"legid", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Startloc(), ecorePackage.getEInt(),
				"startloc", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Endloc(), ecorePackage.getEInt(),
				"endloc", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Dutysignon(), ecorePackage.getEInt(),
				"dutysignon", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Starttime(), ecorePackage.getEInt(),
				"starttime", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Endtime(), ecorePackage.getEInt(),
				"endtime", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Dutysignoff(), ecorePackage.getEInt(),
				"dutysignoff", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Duration(), ecorePackage.getEInt(),
				"duration", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Nib(), ecorePackage.getEInt(), "nib",
				null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getOutlinkEngine_Spareflag(), ecorePackage.getEInt(),
				"spareflag", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutlinkEngine_Sortorder(), ecorePackage.getEInt(),
				"sortorder", null, 1, 1, OutlinkEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(outlinkEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(lobbyMstEngineEClass, LobbyMstEngine.class,
				"LobbyMstEngine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLobbyMstEngine_LobbyCode(),
				ecorePackage.getEString(), "lobbyCode", null, 1, 1,
				LobbyMstEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLobbyMstEngine_LobbyName(),
				ecorePackage.getEString(), "lobbyName", null, 1, 1,
				LobbyMstEngine.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLobbyMstEngine_LobbyId(), ecorePackage.getEInt(),
				"lobbyId", null, 1, 1, LobbyMstEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(lobbyMstEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getUserMst_User(), ecorePackage.getEString(), "user",
				...
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getUserMst_DivisionId(), ecorePackage.getEInt(),
				"divisionId", null, 0, 1, UserMst.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		...
		initEClass(dayMstEngineEClass, DayMstEngine.class, "DayMstEngine",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDayMstEngine_DayId(), ecorePackage.getEInt(),
				"dayId", null, 1, 1, DayMstEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDayMstEngine_DayDesc(), ecorePackage.getEString(),
				"dayDesc", null, 1, 1, DayMstEngine.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		addEOperation(dayMstEngineEClass, this.getCclmsCollector(),
				"getCollector", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getCclmsCollector_LobbyMst(), this.getLobbyMst(), null,
				...
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_TrainSegmentEngine(),
				this.getTrainSegmentEngine(), null, "trainSegmentEngine", null,
				0, -1, CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_SegmentMstEngine(),
				this.getSegmentMstEngine(), null, "segmentMstEngine", null, 0,
				-1, CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_TimeToMinEngine(),
				this.getTimeToMinEngine(), null, "timeToMinEngine", null, 0,
				-1, CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_KpiLinkEngine(),
				this.getKpiLinkEngine(), null, "kpiLinkEngine", null, 0, -1,
				CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_LinkDetailEngine(),
				this.getLinkDetailEngine(), null, "linkDetailEngine", null, 0,
				-1, CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_OutlinkEngine(),
				this.getOutlinkEngine(), null, "outlinkEngine", null, 0, -1,
				CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_LobbyMstEngine(),
				this.getLobbyMstEngine(), null, "lobbyMstEngine", null, 0, -1,
				CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_UserMst(), this.getUserMst(), null,
				...
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCclmsCollector_DayMstEngine(),
				this.getDayMstEngine(), null, "dayMstEngine", null, 0, -1,
				CclmsCollector.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(cclmsCollectorEClass, this.getTrainSegmentEngine(),
				"createTrainSegmentEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getTrainSegmentEngine(),
				"createTrainSegmentEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getTrainSegmentEngine(),
				"getFromTrainSegmentEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "trainid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "legid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "dayid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "spareflag", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(cclmsCollectorEClass, this.getSegmentMstEngine(),
				"createSegmentMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getSegmentMstEngine(),
				"createSegmentMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getSegmentMstEngine(),
				"getFromSegmentMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "segmentid", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(cclmsCollectorEClass, this.getTimeToMinEngine(),
				"createTimeToMinEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getTimeToMinEngine(),
				"createTimeToMinEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getTimeToMinEngine(),
				"getFromTimeToMinEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "trainid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "segmentid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		addEOperation(cclmsCollectorEClass, this.getKpiLinkEngine(),
				"createKpiLinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getKpiLinkEngine(),
				"createKpiLinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getKpiLinkEngine(),
				"getFromKpiLinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "kpiId", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		addEOperation(cclmsCollectorEClass, this.getLinkDetailEngine(),
				"createLinkDetailEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getLinkDetailEngine(),
				"createLinkDetailEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getLinkDetailEngine(),
				"getFromLinkDetailEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "trainno", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "fromstation", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "tostation", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "dayid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "spareflag", 0, 1, IS_UNIQUE,
		...
		addEOperation(cclmsCollectorEClass, this.getOutlinkEngine(),
				"createOutlinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getOutlinkEngine(),
				"createOutlinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getOutlinkEngine(),
				"getFromOutlinkEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "dayid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "seqid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "pairingid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "dutyid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "trainid", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "legid", 0, 1, IS_UNIQUE,
		...
		addEOperation(cclmsCollectorEClass, this.getLobbyMstEngine(),
				"createLobbyMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getLobbyMstEngine(),
				"createLobbyMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getLobbyMstEngine(),
				"getFromLobbyMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "lobbyId", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		...
		addEOperation(cclmsCollectorEClass, this.getDayMstEngine(),
				"createDayMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(cclmsCollectorEClass, this.getDayMstEngine(),
				"createDayMstEngine", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEInt(), "index", 0, 1, IS_UNIQUE,
				IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(stationMstEClass, source, new String[] {
				...
				"STATION_ID,STATION_CODE,STATION_NAME,LOBBY_FLAG",
				"odme.types",
		...
		addAnnotation(getTractionMst_RefLinkMstTractionType(), source,
				new String[] { "odme.displayName", "" });
		addAnnotation(trainMstEClass, source, new String[] {
				"odme.displayName", "TRAIN_MST", "odme.table", "TRAIN_MST",
				"odme.primarykey", "TRAIN_ID", "odme.columns",
				"TRAIN_ID,TRAIN_NBR,TRAIN_NAME", "odme.types",
		...
		addAnnotation(parameterValueEClass, source, new String[] {
				...
				"odme.columns", "PARAMETER_ID,LINK_ID,VALUE", "odme.types",
				"FIELD_INT,FIELD_INT,FIELD_DOUBLE" });
		...
		addAnnotation(getKpiValue_Value(), source, new String[] {
				"odme.displayName", "VALUE", "odme.column", "VALUE" });
		addAnnotation(getKpiValue_CreatedBy(), source, new String[] {
				"odme.displayName", "CREATED_BY", "odme.column", "CREATED_BY" });
		...
		addAnnotation(
				...
				new String[] {
						...
						"PARAMETER_ID",
						"odme.columns",
						"PARAMETER_ID,PARAMETER_DESC,UOM,GLOBAL_VALUE,MIN_VALUE,MAX_VALUE",
						"odme.types",
						"FIELD_INT,FIELD_STRING,FIELD_STRING,FIELD_DOUBLE,FIELD_DOUBLE,FIELD_DOUBLE" });
		...
		addAnnotation(trainTypeMstEClass, source, new String[] {
				...
				"odme.columns", "TRAIN_TYPE_CCLMS_ID,TRAIN_TYPE_DESC",
				"odme.types", "FIELD_INT,FIELD_STRING" });
		...
		addAnnotation(getTrainTypeMst_RefLinkMstTrainTypeCd(), source,
				new String[] { "odme.displayName", "" });
		addAnnotation(trainTypeMappingMstEClass, source, new String[] {
				"odme.displayName", "TRAIN_TYPE_MAPPING_MST", "odme.table",
				"TRAIN_TYPE_MAPPING_MST", "odme.primarykey", "TRAIN_TYPE",
				"odme.columns", "TRAIN_TYPE,TRAIN_TYPE_DESC,TRAIN_TYPE_CCLMS",
				"odme.types", "FIELD_STRING,FIELD_STRING,FIELD_INT" });
		...
		addAnnotation(segmentMstEClass, source, new String[] {
				...
				"SEGMENT_ID,START_STATION_ID,STOP_STATION_ID", "odme.types",
		...
		addAnnotation(getTrainSegmentMst_CreatedBy(), source, new String[] {
				"odme.displayName", "CREATED_BY", "odme.column", "CREATED_BY" });
		...
		addAnnotation(getLinkMst_CreatedBy(), source, new String[] {
				"odme.displayName", "CREATED_BY", "odme.column", "CREATED_BY" });
		addAnnotation(getLinkMst_LastModifiedBy(), source, new String[] {
				"odme.displayName", "LAST_MODIFIED_BY", "odme.column",
				"LAST_MODIFIED_BY" });
		...
		addAnnotation(
				...
				new String[] {
						...
						"odme.columns",
						"TRAINID,LEGID,STARTLOC,ENDLOC,SIGNON,START,END,SIGNOFF,DURATION,DISTANCE,NIGHTFLAG,DAYID,SPAREFLAG",
						"odme.types",
						"FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT" });
		addAnnotation(getTrainSegmentEngine_Trainid(), source, new String[] {
				"odme.displayName", "TRAINID", "odme.column", "TRAINID",
				"odme.keyPart", "true" });
		addAnnotation(getTrainSegmentEngine_Legid(), source, new String[] {
				"odme.displayName", "LEGID", "odme.column", "LEGID",
				"odme.keyPart", "true" });
		addAnnotation(getTrainSegmentEngine_Startloc(), source, new String[] {
				"odme.displayName", "STARTLOC", "odme.column", "STARTLOC" });
		addAnnotation(getTrainSegmentEngine_Endloc(), source, new String[] {
				"odme.displayName", "ENDLOC", "odme.column", "ENDLOC" });
		addAnnotation(getTrainSegmentEngine_Signon(), source, new String[] {
				"odme.displayName", "SIGNON", "odme.column", "SIGNON" });
		addAnnotation(getTrainSegmentEngine_Start(), source, new String[] {
				"odme.displayName", "START", "odme.column", "START" });
		addAnnotation(getTrainSegmentEngine_End(), source, new String[] {
				"odme.displayName", "END", "odme.column", "END" });
		addAnnotation(getTrainSegmentEngine_Signoff(), source, new String[] {
				"odme.displayName", "SIGNOFF", "odme.column", "SIGNOFF" });
		addAnnotation(getTrainSegmentEngine_Duration(), source, new String[] {
				"odme.displayName", "DURATION", "odme.column", "DURATION" });
		addAnnotation(getTrainSegmentEngine_Distance(), source, new String[] {
				"odme.displayName", "DISTANCE", "odme.column", "DISTANCE" });
		addAnnotation(getTrainSegmentEngine_Nightflag(), source, new String[] {
				"odme.displayName", "NIGHTFLAG", "odme.column", "NIGHTFLAG" });
		addAnnotation(getTrainSegmentEngine_Dayid(), source, new String[] {
				"odme.displayName", "DAYID", "odme.column", "DAYID",
				"odme.keyPart", "true" });
		addAnnotation(getTrainSegmentEngine_Spareflag(), source, new String[] {
				"odme.displayName", "SPAREFLAG", "odme.column", "SPAREFLAG",
				"odme.keyPart", "true" });
		addAnnotation(segmentMstEngineEClass, source, new String[] {
				"odme.displayName", "SEGMENT_MST_ENGINE", "odme.table",
				"SEGMENT_MST_ENGINE", "odme.primarykey", "SEGMENTID",
				"odme.columns", "FROMSTATION,TOSTATION,SEGMENTID",
				"odme.types", "FIELD_STRING,FIELD_STRING,FIELD_INT" });
		addAnnotation(getSegmentMstEngine_Fromstation(), source,
				new String[] { "odme.displayName", "FROMSTATION",
						"odme.column", "FROMSTATION" });
		addAnnotation(getSegmentMstEngine_Tostation(), source, new String[] {
				"odme.displayName", "TOSTATION", "odme.column", "TOSTATION" });
		addAnnotation(getSegmentMstEngine_Segmentid(), source, new String[] {
				"odme.displayName", "SEGMENTID", "odme.column", "SEGMENTID",
				"odme.keyPart", "true" });
		addAnnotation(
				timeToMinEngineEClass,
				source,
				new String[] {
						"odme.displayName",
						"TIME_TO_MIN_ENGINE",
						...
						"odme.columns",
						"TRAINID,SEGMENTID,SIGNONTIME,SIGNOMINUTE,STARTTIME,STARTMINUTE,ENDTIME,ENDMINUTE,SIGNOFFTIME,SIGNOFFMINUTE,DAYID,SPAREFLAG",
						"odme.types",
						"FIELD_INT,FIELD_INT,FIELD_STRING,FIELD_INT,FIELD_STRING,FIELD_INT,FIELD_STRING,FIELD_INT,FIELD_STRING,FIELD_INT,FIELD_INT,FIELD_INT" });
		addAnnotation(getTimeToMinEngine_Trainid(), source, new String[] {
				"odme.displayName", "TRAINID", "odme.column", "TRAINID",
				"odme.keyPart", "true" });
		addAnnotation(getTimeToMinEngine_Segmentid(), source, new String[] {
				"odme.displayName", "SEGMENTID", "odme.column", "SEGMENTID",
				"odme.keyPart", "true" });
		addAnnotation(getTimeToMinEngine_Signontime(), source, new String[] {
				"odme.displayName", "SIGNONTIME", "odme.column", "SIGNONTIME" });
		addAnnotation(getTimeToMinEngine_Signominute(), source,
				new String[] { "odme.displayName", "SIGNOMINUTE",
						"odme.column", "SIGNOMINUTE" });
		addAnnotation(getTimeToMinEngine_Starttime(), source, new String[] {
				"odme.displayName", "STARTTIME", "odme.column", "STARTTIME" });
		addAnnotation(getTimeToMinEngine_Startminute(), source,
				new String[] { "odme.displayName", "STARTMINUTE",
						"odme.column", "STARTMINUTE" });
		addAnnotation(getTimeToMinEngine_Endtime(), source, new String[] {
				"odme.displayName", "ENDTIME", "odme.column", "ENDTIME" });
		addAnnotation(getTimeToMinEngine_Endminute(), source, new String[] {
				"odme.displayName", "ENDMINUTE", "odme.column", "ENDMINUTE" });
		addAnnotation(getTimeToMinEngine_Signofftime(), source,
				new String[] { "odme.displayName", "SIGNOFFTIME",
						"odme.column", "SIGNOFFTIME" });
		addAnnotation(getTimeToMinEngine_Signoffminute(), source, new String[] {
				"odme.displayName", "SIGNOFFMINUTE", "odme.column",
				"SIGNOFFMINUTE" });
		addAnnotation(getTimeToMinEngine_Dayid(), source, new String[] {
				"odme.displayName", "DAYID", "odme.column", "DAYID",
				"odme.keyPart", "true" });
		addAnnotation(getTimeToMinEngine_Spareflag(), source, new String[] {
				"odme.displayName", "SPAREFLAG", "odme.column", "SPAREFLAG",
				"odme.keyPart", "true" });
		addAnnotation(kpiLinkEngineEClass, source, new String[] {
				"odme.displayName", "KPI_LINK_ENGINE", "odme.table",
				"KPI_LINK_ENGINE", "odme.primarykey", "KPI_ID", "odme.columns",
				"KPI_ID,KPI_DESC,KPI_VALUE,UOM", "odme.types",
				"FIELD_INT,FIELD_STRING,FIELD_DOUBLE,FIELD_STRING" });
		addAnnotation(getKpiLinkEngine_KpiId(), source, new String[] {
				"odme.displayName", "KPI_ID", "odme.column", "KPI_ID",
				"odme.keyPart", "true" });
		addAnnotation(getKpiLinkEngine_KpiDesc(), source, new String[] {
				"odme.displayName", "KPI_DESC", "odme.column", "KPI_DESC" });
		addAnnotation(getKpiLinkEngine_KpiValue(), source, new String[] {
				"odme.displayName", "KPI_VALUE", "odme.column", "KPI_VALUE" });
		addAnnotation(getKpiLinkEngine_Uom(), source, new String[] {
				"odme.displayName", "UOM", "odme.column", "UOM" });
		addAnnotation(
				linkDetailEngineEClass,
				source,
				new String[] {
						"odme.displayName",
						"LINK_DETAIL_ENGINE",
						...
						"odme.columns",
						"DAYNAME,SEQID,TRAINNO,FROMSTATION,TOSTATION,SIGNONTIME,DEPARTURETIME,ARRIVALTIME,SIGNOFFTIME,DUTYDURTION,DUTYMINUTES,DISTANCE,NIB,SORTORDER,DAYID,SPAREFLAG",
						"odme.types",
						"FIELD_STRING,FIELD_INT,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_STRING,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT" });
		addAnnotation(getLinkDetailEngine_Dayname(), source, new String[] {
				"odme.displayName", "DAYNAME", "odme.column", "DAYNAME" });
		addAnnotation(getLinkDetailEngine_Seqid(), source, new String[] {
				"odme.displayName", "SEQID", "odme.column", "SEQID" });
		addAnnotation(getLinkDetailEngine_Trainno(), source, new String[] {
				"odme.displayName", "TRAINNO", "odme.column", "TRAINNO",
				"odme.keyPart", "true" });
		addAnnotation(getLinkDetailEngine_Fromstation(), source, new String[] {
				"odme.displayName", "FROMSTATION", "odme.column",
				"FROMSTATION", "odme.keyPart", "true" });
		addAnnotation(getLinkDetailEngine_Tostation(), source, new String[] {
				"odme.displayName", "TOSTATION", "odme.column", "TOSTATION",
				"odme.keyPart", "true" });
		addAnnotation(getLinkDetailEngine_Signontime(), source, new String[] {
				"odme.displayName", "SIGNONTIME", "odme.column", "SIGNONTIME" });
		addAnnotation(getLinkDetailEngine_Departuretime(), source,
				new String[] { "odme.displayName", "DEPARTURETIME",
						"odme.column", "DEPARTURETIME" });
		addAnnotation(getLinkDetailEngine_Arrivaltime(), source,
				new String[] { "odme.displayName", "ARRIVALTIME",
						"odme.column", "ARRIVALTIME" });
		addAnnotation(getLinkDetailEngine_Signofftime(), source,
				new String[] { "odme.displayName", "SIGNOFFTIME",
						"odme.column", "SIGNOFFTIME" });
		addAnnotation(getLinkDetailEngine_Dutydurtion(), source,
				new String[] { "odme.displayName", "DUTYDURTION",
						"odme.column", "DUTYDURTION" });
		addAnnotation(getLinkDetailEngine_Dutyminutes(), source,
				new String[] { "odme.displayName", "DUTYMINUTES",
						"odme.column", "DUTYMINUTES" });
		addAnnotation(getLinkDetailEngine_Distance(), source, new String[] {
				"odme.displayName", "DISTANCE", "odme.column", "DISTANCE" });
		addAnnotation(getLinkDetailEngine_Nib(), source, new String[] {
				"odme.displayName", "NIB", "odme.column", "NIB" });
		addAnnotation(getLinkDetailEngine_Sortorder(), source, new String[] {
				"odme.displayName", "SORTORDER", "odme.column", "SORTORDER" });
		addAnnotation(getLinkDetailEngine_Dayid(), source, new String[] {
				"odme.displayName", "DAYID", "odme.column", "DAYID",
				"odme.keyPart", "true" });
		addAnnotation(getLinkDetailEngine_Spareflag(), source, new String[] {
				"odme.displayName", "SPAREFLAG", "odme.column", "SPAREFLAG",
				"odme.keyPart", "true" });
		addAnnotation(
				outlinkEngineEClass,
				...
				new String[] {
						...
						"OUTLINK_ENGINE",
						"odme.primarykey",
						"DAYID,SEQID,PAIRINGID,DUTYID,TRAINID,LEGID",
						"odme.columns",
						"DAYID,SEQID,PAIRINGID,DUTYID,TRAINID,LEGID,STARTLOC,ENDLOC,DUTYSIGNON,STARTTIME,ENDTIME,DUTYSIGNOFF,DURATION,NIB,SPAREFLAG,SORTORDER",
						"odme.types",
						"FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT,FIELD_INT" });
		addAnnotation(getOutlinkEngine_Dayid(), source, new String[] {
				"odme.displayName", "DAYID", "odme.column", "DAYID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Seqid(), source, new String[] {
				"odme.displayName", "SEQID", "odme.column", "SEQID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Pairingid(), source, new String[] {
				"odme.displayName", "PAIRINGID", "odme.column", "PAIRINGID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Dutyid(), source, new String[] {
				"odme.displayName", "DUTYID", "odme.column", "DUTYID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Trainid(), source, new String[] {
				"odme.displayName", "TRAINID", "odme.column", "TRAINID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Legid(), source, new String[] {
				"odme.displayName", "LEGID", "odme.column", "LEGID",
				"odme.keyPart", "true" });
		addAnnotation(getOutlinkEngine_Startloc(), source, new String[] {
				"odme.displayName", "STARTLOC", "odme.column", "STARTLOC" });
		addAnnotation(getOutlinkEngine_Endloc(), source, new String[] {
				"odme.displayName", "ENDLOC", "odme.column", "ENDLOC" });
		addAnnotation(getOutlinkEngine_Dutysignon(), source, new String[] {
				"odme.displayName", "DUTYSIGNON", "odme.column", "DUTYSIGNON" });
		addAnnotation(getOutlinkEngine_Starttime(), source, new String[] {
				"odme.displayName", "STARTTIME", "odme.column", "STARTTIME" });
		addAnnotation(getOutlinkEngine_Endtime(), source, new String[] {
				"odme.displayName", "ENDTIME", "odme.column", "ENDTIME" });
		addAnnotation(getOutlinkEngine_Dutysignoff(), source,
				new String[] { "odme.displayName", "DUTYSIGNOFF",
						"odme.column", "DUTYSIGNOFF" });
		addAnnotation(getOutlinkEngine_Duration(), source, new String[] {
				"odme.displayName", "DURATION", "odme.column", "DURATION" });
		addAnnotation(getOutlinkEngine_Nib(), source, new String[] {
				"odme.displayName", "NIB", "odme.column", "NIB" });
		addAnnotation(getOutlinkEngine_Spareflag(), source, new String[] {
				"odme.displayName", "SPAREFLAG", "odme.column", "SPAREFLAG" });
		addAnnotation(getOutlinkEngine_Sortorder(), source, new String[] {
				"odme.displayName", "SORTORDER", "odme.column", "SORTORDER" });
		addAnnotation(lobbyMstEngineEClass, source, new String[] {
				"odme.displayName", "LOBBY_MST_ENGINE", "odme.table",
				"LOBBY_MST_ENGINE", "odme.primarykey", "LOBBY_ID",
				"odme.columns", "LOBBY_CODE,LOBBY_NAME,LOBBY_ID", "odme.types",
				"FIELD_STRING,FIELD_STRING,FIELD_INT" });
		addAnnotation(getLobbyMstEngine_LobbyCode(), source, new String[] {
				"odme.displayName", "LOBBY_CODE", "odme.column", "LOBBY_CODE" });
		addAnnotation(getLobbyMstEngine_LobbyName(), source, new String[] {
				"odme.displayName", "LOBBY_NAME", "odme.column", "LOBBY_NAME" });
		addAnnotation(getLobbyMstEngine_LobbyId(), source, new String[] {
				"odme.displayName", "LOBBY_ID", "odme.column", "LOBBY_ID",
				"odme.keyPart", "true" });
		addAnnotation(userMstEClass, source, new String[] { "odme.displayName",
				"USER_MST", "odme.table", "USER_MST", "odme.columns",
				"USER_ID,USER,DIVISION_ID", "odme.types",
		...
		addAnnotation(getUserMst_DivisionId(), source,
				new String[] { "odme.displayName", "DIVISION_ID",
						"odme.column", "DIVISION_ID" });
		addAnnotation(dayMstEngineEClass, source, new String[] {
				"odme.displayName", "DAY_MST_ENGINE", "odme.table",
				"DAY_MST_ENGINE", "odme.columns", "DAY_ID,DAY_DESC",
				"odme.types", "FIELD_INT,FIELD_STRING" });
		addAnnotation(getDayMstEngine_DayId(), source, new String[] {
				"odme.displayName", "DAY_ID", "odme.column", "DAY_ID" });
		addAnnotation(getDayMstEngine_DayDesc(), source, new String[] {
				"odme.displayName", "DAY_DESC", "odme.column", "DAY_DESC" });
		...
		addAnnotation(cclmsCollectorEClass.getEOperations().get(43), source,
				new String[] { "odme.factory", "TrainSegmentEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(44), source,
				new String[] { "odme.factory", "TrainSegmentEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(46), source,
				new String[] { "odme.factory", "SegmentMstEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(47), source,
				new String[] { "odme.factory", "SegmentMstEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(49), source,
				new String[] { "odme.factory", "TimeToMinEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(50), source,
				new String[] { "odme.factory", "TimeToMinEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(52), source,
				new String[] { "odme.factory", "KpiLinkEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(53), source,
				new String[] { "odme.factory", "KpiLinkEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(55), source,
				new String[] { "odme.factory", "LinkDetailEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(56), source,
				new String[] { "odme.factory", "LinkDetailEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(58), source,
				new String[] { "odme.factory", "OutlinkEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(59), source,
				new String[] { "odme.factory", "OutlinkEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(61), source,
				new String[] { "odme.factory", "LobbyMstEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(62), source,
				new String[] { "odme.factory", "LobbyMstEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(64), source,
				new String[] { "odme.factory", "UserMst" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(65), source,
				new String[] { "odme.factory", "UserMst" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(66), source,
				new String[] { "odme.factory", "DayMstEngine" });
		addAnnotation(cclmsCollectorEClass.getEOperations().get(67), source,
				new String[] { "odme.factory", "DayMstEngine" });
		...
		addAnnotation(getCclmsCollector_TrainSegmentEngine(), source,
				new String[] { "odme.collector", "TrainSegmentEngine" });
		addAnnotation(getCclmsCollector_SegmentMstEngine(), source,
				new String[] { "odme.collector", "SegmentMstEngine" });
		addAnnotation(getCclmsCollector_TimeToMinEngine(), source,
				new String[] { "odme.collector", "TimeToMinEngine" });
		addAnnotation(getCclmsCollector_KpiLinkEngine(), source, new String[] {
				"odme.collector", "KpiLinkEngine" });
		addAnnotation(getCclmsCollector_LinkDetailEngine(), source,
				new String[] { "odme.collector", "LinkDetailEngine" });
		addAnnotation(getCclmsCollector_OutlinkEngine(), source, new String[] {
				"odme.collector", "OutlinkEngine" });
		addAnnotation(getCclmsCollector_LobbyMstEngine(), source, new String[] {
				"odme.collector", "LobbyMstEngine" });
		addAnnotation(getCclmsCollector_UserMst(), source, new String[] {
				"odme.collector", "UserMst" });
		addAnnotation(getCclmsCollector_DayMstEngine(), source, new String[] {
				"odme.collector", "DayMstEngine" });
	}
	...
	protected void createGenModelAnnotations() {
		...
		addAnnotation(stationMstEClass.getEOperations().get(0), source,
		...
		addAnnotation(stationMstEClass.getEOperations().get(3), source,
				new String[] { "body",
		...
		addAnnotation(
				stationMstEClass.getEOperations().get(7),
				source,
		...
		addAnnotation(
				trainFrequencyMstEClass.getEOperations().get(1),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(getTrainFrequencyMst_RefLinkMstTrainFrequencyCd(),
		...
		addAnnotation(getTractionMst_RefLinkMstTractionType(), source,
				new String[] { "suppressedSetVisibility", "true",
						...
						"suppressedUnsetVisibility", "true",
						"suppressedIsSetVisibility", "true" });
		addAnnotation(trainMstEClass.getEOperations().get(0), source,
				new String[] { "body", "return getRefLinkDetailTrainId();" });
		addAnnotation(
				trainMstEClass.getEOperations().get(1),
				source,
		...
		addAnnotation(getParameterMst_RefParameterValueParameterId(), source,
				new String[] { "suppressedSetVisibility", "true",
						...
						"suppressedUnsetVisibility", "true",
						"suppressedIsSetVisibility", "true" });
		addAnnotation(trainTypeMstEClass.getEOperations().get(0), source,
				new String[] { "body",
		...
		addAnnotation(
				trainTypeMstEClass.getEOperations().get(2),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(getTrainTypeMst_RefTrainTypeMappingMstTrainTypeCclms(),
				source, new String[] { "suppressedSetVisibility", "true",
		...
		addAnnotation(getTrainTypeMst_RefLinkMstTrainTypeCd(), source,
				new String[] { "suppressedSetVisibility", "true",
						...
						"suppressedIsSetVisibility", "true" });
		addAnnotation(
				trainTypeMappingMstEClass.getEOperations().get(0),
				source,
				new String[] { "body",
						"TrainTypeMst obj= getRefTrainTypeCclms();return isNullOrProxy(obj)?null:obj;" });
		addAnnotation(trainTypeMappingMstEClass.getEOperations().get(1),
		...
		addAnnotation(segmentMstEClass.getEOperations().get(4), source,
				new String[] { "body",
						"return getRefTrainSegmentMstSegmentId();" });
		addAnnotation(
				segmentMstEClass.getEOperations().get(5),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(getSegmentMst_RefStartStationId(), source, new String[] {
				"suppressedSetVisibility", "true", "suppressedGetVisibility",
		...
		addAnnotation(
				...
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				trainSegmentEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				segmentMstEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				timeToMinEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				kpiLinkEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				linkDetailEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				outlinkEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				lobbyMstEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				userMstEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
				dayMstEngineEClass.getEOperations().get(0),
				source,
				new String[] { "body", "return (CclmsCollector) eContainer();" });
		addAnnotation(
		...
		addAnnotation(
				...
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TrainSegmentEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(TrainSegmentEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(44),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TrainSegmentEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(TrainSegmentEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(45),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TrainSegmentEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(TrainSegmentEngine.class,new Object[]{trainid,legid,dayid,spareflag});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(46),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (SegmentMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(SegmentMstEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(47),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (SegmentMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(SegmentMstEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(48),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (SegmentMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(SegmentMstEngine.class,new Object[]{segmentid});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(49),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TimeToMinEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(TimeToMinEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(50),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TimeToMinEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(TimeToMinEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(51),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (TimeToMinEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(TimeToMinEngine.class,new Object[]{trainid,segmentid,dayid,spareflag});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(52),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (KpiLinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(KpiLinkEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(53),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (KpiLinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(KpiLinkEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(54),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (KpiLinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(KpiLinkEngine.class,new Object[]{kpiId});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(55),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LinkDetailEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(LinkDetailEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(56),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LinkDetailEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(LinkDetailEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(57),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LinkDetailEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(LinkDetailEngine.class,new Object[]{trainno,fromstation,tostation,dayid,spareflag});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(58),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (OutlinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(OutlinkEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(59),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (OutlinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(OutlinkEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(60),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (OutlinkEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(OutlinkEngine.class,new Object[]{dayid,seqid,pairingid,dutyid,trainid,legid});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(61),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LobbyMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(LobbyMstEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(62),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LobbyMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(LobbyMstEngine.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(63),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (LobbyMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).getObjectByKey(LobbyMstEngine.class,new Object[]{lobbyId});\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(64),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (UserMst)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(UserMst.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(65),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (UserMst)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(UserMst.class,index);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(66),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (DayMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObject(DayMstEngine.class);\n}\nreturn null;" });
		addAnnotation(
				cclmsCollectorEClass.getEOperations().get(67),
				source,
				new String[] {
						"body",
						"if (eResource()!=null && eResource() instanceof ilog.odm.dom.impl.resource.IloDomResourceImpl) {\nreturn (DayMstEngine)((ilog.odm.dom.impl.resource.IloDomResourceImpl)eResource()).createEObjectAt(DayMstEngine.class,index);\n}\nreturn null;" });
	}
